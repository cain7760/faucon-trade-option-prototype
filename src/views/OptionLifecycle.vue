...
const baseRows: Omit<LifecycleRow, 'id' | 'eventNo'>[] = [
  {
    ...
    hedger: 'CICC_option',
    hedgerCount: 1,
    customerCurrentNotional: '800,000',
    hedgerCurrentNotional: '750,000',
    ...
    customerClosePrice: '10.32',
    hedgerClosePrice: '10.15',
    customerSettlement: '156,000',
    hedgerSettlement: '148,000',
    openRevenue: '100,000',
    closeRevenue: '8,000',
    currency: 'CNY',
  ...
  },
  {
    ...
    hedger: 'CLSA_option',
    hedgerCount: 2,
    customerCurrentNotional: '12,000,000',
    ...
    customerSettlement: '1,295,000',
    hedgerSettlement: '1,694,000',
    openRevenue: '120,000',
    closeRevenue: '66,000',
    currency: 'CNY',
  ...
  },
  {
    ...
    hedger: 'CICC_option',
    hedgerCount: 1,
    customerCurrentNotional: '6,000,000',
    hedgerCurrentNotional: '6,000,000',
  ...
  {
    optionInfo: '600036.SH-105C-100%-2M-20260301-20260501',
    tenor: '2M',
    strikeRate: 105,
    counterparty: 'Zhang_option',
    hedger: 'HTSC_option',
    hedgerCount: 1,
    customerCurrentNotional: '5,000,000',
    hedgerCurrentNotional: '5,000,000',
    contractNo: 'HTSC-OPT-Zhang-20260301-0004',
    underlying: '招商银行（600036）',
    openDate: '2026-03-01',
    customerInitialNotional: '15,000,000',
    hedgerInitialNotional: '15,000,000',
    customerPremiumRate: '3.85%',
    hedgerPremiumRate: '3.62%',
    customerOpenPrice: '45.20',
    hedgerOpenPrice: '45.05',
    closeDate: '2026-05-01',
    customerClosePrice: '46.80',
    hedgerClosePrice: '46.62',
    customerSettlement: '380,000',
    hedgerSettlement: '365,000',
    openRevenue: '55,000',
    closeRevenue: '15,000',
    currency: 'CNY',
    customerPremium: '577,500',
    hedgerPremium: '543,000',
    status: '了结',
  },
  {
    optionInfo: '601318.SH-90P-100%-1M-20260315-20260415',
    tenor: '1M',
    strikeRate: 90,
    counterparty: 'Li_option',
    hedger: 'CITICS_option',
    hedgerCount: 1,
    customerCurrentNotional: '3,000,000',
    hedgerCurrentNotional: '3,000,000',
    contractNo: 'CITICS-OPT-Li-20260315-0005',
    underlying: '中国平安（601318）',
    openDate: '2026-03-15',
    customerInitialNotional: '8,000,000',
    hedgerInitialNotional: '8,000,000',
    customerPremiumRate: '2.95%',
    hedgerPremiumRate: '2.78%',
    customerOpenPrice: '52.10',
    hedgerOpenPrice: '51.95',
    closeDate: '2026-04-15',
    customerClosePrice: '50.30',
    hedgerClosePrice: '50.15',
    customerSettlement: '215,000',
    hedgerSettlement: '202,000',
    openRevenue: '40,000',
    closeRevenue: '13,000',
    currency: 'CNY',
    customerPremium: '236,000',
    hedgerPremium: '222,400',
    status: '了结',
  },
  {
    optionInfo: '000333.SZ-110C-100%-3M-20260410-20260710',
    tenor: '3M',
    strikeRate: 110,
    counterparty: 'Wang_option',
    hedger: 'GF_option',
    hedgerCount: 1,
    customerCurrentNotional: '10,000,000',
    hedgerCurrentNotional: '10,000,000',
    contractNo: 'GF-OPT-Wang-20260410-0006',
    underlying: '美的集团（000333）',
    openDate: '2026-04-10',
    customerInitialNotional: '25,000,000',
    hedgerInitialNotional: '25,000,000',
    customerPremiumRate: '4.15%',
    hedgerPremiumRate: '3.92%',
    customerOpenPrice: '68.50',
    hedgerOpenPrice: '68.30',
    closeDate: '2026-07-10',
    customerClosePrice: '71.20',
    hedgerClosePrice: '71.00',
    customerSettlement: '520,000',
    hedgerSettlement: '498,000',
    openRevenue: '90,000',
    closeRevenue: '22,000',
    currency: 'CNY',
    customerPremium: '1,037,500',
    hedgerPremium: '980,000',
    status: '了结',
  },
  {
    optionInfo: '600519.SH-95P-100%-2M-20260502-20260702',
    tenor: '2M',
    strikeRate: 95,
    counterparty: 'Chen_option',
    hedger: 'CMB_option',
    hedgerCount: 1,
    customerCurrentNotional: '7,000,000',
    hedgerCurrentNotional: '7,000,000',
    contractNo: 'CMB-OPT-Chen-20260502-0007',
    underlying: '贵州茅台（600519）',
    openDate: '2026-05-02',
    customerInitialNotional: '18,000,000',
    hedgerInitialNotional: '18,000,000',
    customerPremiumRate: '3.45%',
    hedgerPremiumRate: '3.28%',
    customerOpenPrice: '1,420.00',
    hedgerOpenPrice: '1,418.00',
    closeDate: '2026-07-02',
    customerClosePrice: '1,455.00',
    hedgerClosePrice: '1,452.00',
    customerSettlement: '470,000',
    hedgerSettlement: '455,000',
    openRevenue: '75,000',
    closeRevenue: '15,000',
    currency: 'CNY',
    customerPremium: '621,000',
    hedgerPremium: '590,400',
    status: '了结',
  },
  {
    optionInfo: '000858.SZ-100C-100%-1M-20260601-20260701',
    tenor: '1M',
    strikeRate: 100,
    counterparty: 'Zhao_option',
    hedger: 'Haitong_option',
    hedgerCount: 1,
    customerCurrentNotional: '4,000,000',
    hedgerCurrentNotional: '4,000,000',
    contractNo: 'Haitong-OPT-Zhao-20260601-0008',
    underlying: '五粮液（000858）',
    openDate: '2026-06-01',
    customerInitialNotional: '12,000,000',
    hedgerInitialNotional: '12,000,000',
    customerPremiumRate: '3.05%',
    hedgerPremiumRate: '2.88%',
    customerOpenPrice: '130.50',
    hedgerOpenPrice: '130.20',
    closeDate: '2026-07-01',
    customerClosePrice: '133.80',
    hedgerClosePrice: '133.55',
    customerSettlement: '290,000',
    hedgerSettlement: '278,000',
    openRevenue: '48,000',
    closeRevenue: '12,000',
    currency: 'CNY',
    customerPremium: '366,000',
...
const actualCashFlows = [
  { date: '2026-08-03', type: '入金', amount: '+9,860 CNY', description: '客户支付期权费（开仓）' },
  { date: '2026-09-03', type: '出金', amount: '-105,000 CNY', description: '平仓结算支付给客户' },
  {
    date: '2026-09-03',
    type: '换汇现金流',
    amount: '-105,000 CNY',
  ...
  { date: '2026-09-03', type: '划转现金流', amount: '+105,000 CNY', description: '中间账户与上手账户划转' },
  {
    date: '2026-10-03',
    type: '期权费',
    amount: '-105,000 CNY',
